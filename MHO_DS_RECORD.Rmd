...
**R script**:  
```{r, echo=TRUE}
mho_RECORD_0$psy_dep_case_0 <- as.integer(ifelse(RECORD_w1_1$psy_depression_score_0 <= 6,0, ifelse(RECORD_w1_1$psy_depression_score_0 >= 7,1,NA)))
...
**R script**:  
```{r, echo=TRUE}
mho_RECORD_1$psy_dep_case_1 <- as.integer(ifelse(RECORD_w2$psy_depression_score_1 <= 6,0, ifelse(RECORD_w2$psy_depression_score_1 >= 7,1,NA)))
...
**R script**:  
```{r, echo=TRUE}
mho_RECORD_0$psy_dep_yn_0 <- as.integer(ifelse(RECORD_w1_1$Qm208 == "O",1, ifelse(RECORD_w1_1$Qm208 == "N",0,NA)))
...
**R script**:  
```{r, echo=TRUE}
mho_RECORD_1$psy_dep_yn_1 <- as.integer(ifelse(RECORD_w2$Qm208 == "O",1, ifelse(RECORD_w2$Qm208 == "N",0,NA)))
