...
**Harmonization status**: complete  
**Harmonization comment**:  Participants with QD2A depression scores of 7 or higher (out of a possible 13) were defined as cases as per the scale-specific threshold (Pichot 1986). Items comprising the QD2A scale are listed below:          
*Questionnaire of Self-Evaluated Depressive Symptomatology (QD2A) Scale*    
    1. I have difficulty in shaking off the evil thoughts that pass through my head. (Yes/No)      
    2. My memory does not seem to be as good as it used to be. (Yes/No)      
    3. I have no energy. (Yes/No)    
