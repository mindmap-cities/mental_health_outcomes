...
# LUCAS wave 2
opal.assign.table.tibble(erasmus_opal, 'LUCAS_w2data', 'LUCAS.LUCAS_Wave2', variables = list('Lucas20_07'))
lucas_w2 <- opal.execute(erasmus_opal,'LUCAS_w2data')
```
## Assign participant id as first column of your harmonized dataframes
```{r, echo=FALSE}
mho_LUCAS_0 <- data.frame(id = lucas_w2$id)
...
**Harmonization status**: imposssible  
**Harmonization comment**:   
**R script**:  
```{r, echo=TRUE}
#This is where the R-script will be written
...
**R script**:  
```{r, echo=TRUE}
mho_LUCAS_0$psy_dep_yn_0 <- as.integer(lucas_w2$Lucas20_07)
