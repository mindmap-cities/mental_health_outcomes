...
**R script**:  
```{r, echo=TRUE}
mho_HUNT_1$psy_anxiety_case_1 <- as.integer(cut(mho_HUNT_1$psy_anxiety_score_1, breaks=c(0,10,+Inf), labels=c(0,1), include.lowest = TRUE))
...
**R script**:  
```{r, echo=TRUE}
mho_HUNT_2$psy_anxiety_case_2 <- as.integer(cut(mho_HUNT_2$psy_anxiety_score_2, breaks=c(0,10,+Inf), labels=c(0,1), include.lowest = TRUE))
...
**Harmonization status**: complete   
**Harmonization comment**:  The HADS-D depression scores (0-21) were grouped into study-specific tertiles defined as low (0-1), medium (2-3), and high (3-21). Scores were used as provided by the HUNT study.   
**R script**:  
```{r, echo=TRUE}
...
**R script**:  
```{r, echo=TRUE}
mho_HUNT_1$psy_dep_case_1 <- as.integer(cut(HUNT2$HADSDepr_NT2BLQ1, breaks=c(0,10,+Inf), labels=c(0,1), include.lowest = TRUE))
...
**R script**:  
```{r, echo=TRUE}
mho_HUNT_2$psy_dep_case_2 <- as.integer(cut(HUNT3$HADSDepr_NT3BLQ2, breaks=c(0,10,+Inf), labels=c(0,1), include.lowest = TRUE))
...
mho_HUNT_0$psy_distress_case_0 <- as.integer(ifelse(HUNT1$psy_distress_pcrank_0 >= 0.88,1, ifelse(HUNT1$psy_distress_pcrank_0 <= 0.87,0, NA)))
