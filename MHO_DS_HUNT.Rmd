...
**Harmonization comment**:  The HADS-A anxiety scores (0-21) were used as provided by the HUNT study. Items comprising the HADS-A sub-scale are listed below:    
*Hospital Anxiety and Depression - Anxiety Subscale (HADS-A)*    
...
**Harmonization status**: complete        
**Harmonization comment**:  Participants with HADS-A anxiety scores of 11 or higher (out of a possible 21) were defined as cases as per the scale-specific threshold. Items comprising the HADS-A sub-scale are listed below:      
*Hospital Anxiety and Depression - Anxiety Subscale (HADS-A)*      
    1. I feel tense or 'wound up'. (0-3, item-specific)  
    2. I get a sort of frightened feeling as if something awful is about to happen. (0-3, item-specific)    
    3. Worrying thoughts go through my mind. (0-3, item-specific)    
...
**Harmonization status**: complete      
**Harmonization comment**:  The HADS-D depression scores (0-21) were grouped into study-specific tertiles defined as low (0-1), medium (2-3), and high (3-21). Scores were used as provided by the HUNT study. Items comprising the HADS-D sub-scale are listed below:    
*Hospital Anxiety and Depression - Depression Subscale (HADS-D)*     
...
**Harmonization status**: complete   
**Harmonization comment**:  Participants with HADS-D depression scores of 11 or higher (out of a possible 21) were defined as cases as per the scale-specific threshold (Zigmond & Snaith 1983) (Snaith 2003).  Items comprising the HADS-D sub-scale are listed below:      
*Hospital Anxiety and Depression - Depression Subscale (HADS-D)*     
    1. I still enjoy the things I used to enjoy. (0-3, item-specific)  
    2. I can laugh and see the funny side of things. (0-3, item-specific)    
    3. I feel cheerful. (0-3, item-specific)     
...
**Harmonization status**: complete   
**Harmonization comment**:  The ADI-4 anxiety and depression scores (4-22) in HUNT were grouped into study-specific tertiles defined as low(4-7), medium(8-10), and high(11-22). Scores were calculated for participants with data on all 4 items. If participants missed 1 or more items on the ADI-4 scale, scores were not calculated and coded as missing. Items comprising the ADI-4 scale are listed below:    
*Anxiety and Depression Scale, 4 item version (ADI-4)*      
...
**Harmonization status**: complete   
**Harmonization comment**:  The HADS total scores (0-42) in HUNT were grouped into study-specific tertiles defined as low(0-4), medium(5-8), and high(9-42). The HADS total scores were used as provided by the HUNT study. Items comprising the HADS-T total scale are listed below:      
*Hospital Anxiety and Depression - Total Scale (HADS-T)*      
    1. I feel tense or 'wound up'. (0-3, item-specific)  
...
**Harmonization status**: complete   
**Harmonization comment**:  The HADS total scores (0-42) in HUNT were grouped into study-specific tertiles defined as low(0-4), medium(5-8), and high(9-42). he HADS total scores were used as provided by the HUNT study.  Items comprising the HADS-T total scale are listed below:    
*Hospital Anxiety and Depression - Total Scale (HADS-T)*      
    1. I feel tense or 'wound up'. (0-3, item-specific)  
    2. I still enjoy the things I used to enjoy. (0-3, item-specific)    
    3. I get a sort of frightened feeling as if something awful is about to happen. (0-3, item-specific)   
...
**Harmonization status**: complete    
**Harmonization comment**:  Participants with HADS total scores of 15 or higher (out of a possible 42) were defined as cases as per the scale-specific threshold (Bjelland Dahl Haug et al 2002). Items comprising the HADS-T total scale are listed below:        
*Hospital Anxiety and Depression - Total Scale (HADS-T)*        
    1. I feel tense or 'wound up'. (0-3, item-specific)  
    2. I still enjoy the things I used to enjoy. (0-3, item-specific)    
    3. I get a sort of frightened feeling as if something awful is about to happen. (0-3, item-specific)   
