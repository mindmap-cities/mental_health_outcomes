...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_0$psy_life_sat_low_0 <- as.integer(car::recode(LASA1B$bqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_1$psy_life_sat_low_1 <- as.integer(car::recode(LASA1C$cqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_2$psy_life_sat_low_2 <- as.integer(car::recode(LASA1D$dqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_3$psy_life_sat_low_3 <- as.integer(car::recode(LASA1E$eqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_4$psy_life_sat_low_4 <- as.integer(car::recode(LASA1F$fqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_5$psy_life_sat_low_5 <- as.integer(car::recode(LASA1G$gqsatis2, "1:3=1; 4:5=0; else=NA"))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_6$psy_life_sat_low_6 <- as.integer(car::recode(LASA1H$hqsatis2, "1:3=1; 4:5=0; else=NA"))
