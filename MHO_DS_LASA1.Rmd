...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_0$cog_proc_slow_0 <- as.integer(dicho(mho_LASA1_0$cog_proc_std_0, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_1$cog_proc_slow_1 <- as.integer(dicho(mho_LASA1_1$cog_proc_std_1, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_2$cog_proc_slow_2 <- as.integer(dicho(mho_LASA1_2$cog_proc_std_2, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_3$cog_proc_slow_3 <- as.integer(dicho(mho_LASA1_3$cog_proc_std_3, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_4$cog_proc_slow_4 <- as.integer(dicho(mho_LASA1_4$cog_proc_std_4, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_5$cog_proc_slow_5 <- as.integer(dicho(mho_LASA1_5$cog_proc_std_5, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
**R script**:  
```{r, echo=TRUE}
mho_LASA1_6$cog_proc_slow_6 <- as.integer(dicho(mho_LASA1_6$cog_proc_std_6, dich.by = "median", as.num = FALSE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = NULL))
...
mho_LASA1_2$psy_distress_case_2 <- as.integer(ifelse(LASA1D$psy_distress_pct_2 >= 50,1, ifelse(LASA1D$psy_distress_pct_2 <= 49,0,NA)))
...
mho_LASA1_3$psy_distress_case_3 <- as.integer(ifelse(LASA1E$psy_distress_pct_3 >= 50,1, ifelse(LASA1E$psy_distress_pct_3 <= 49,0,NA)))
...
mho_LASA1_4$psy_distress_case_4 <- as.integer(ifelse(LASA1F$psy_distress_pct_4 >= 50,1, ifelse(LASA1F$psy_distress_pct_4 <= 49,0,NA)))
...
mho_LASA1_5$psy_distress_case_5 <- as.integer(ifelse(LASA1G$psy_distress_pct_5 >= 50,1, ifelse(LASA1G$psy_distress_pct_5 <= 49,0,NA)))
...
mho_LASA1_6$psy_distress_case_6 <- as.integer(ifelse(LASA1H$psy_distress_pct_6 >= 50,1, ifelse(LASA1H$psy_distress_pct_6 <= 49,0,NA)))
...
**R script**:  
```{r, echo=TRUE}
LASA1E$eqvall_i <- recode(LASA1E$eqvall, "-2=NA")
...
**Harmonization status**: complete    
**Harmonization comment**:  The Valuation of Life, 12 item version, scores (12-60) were grouped into study-specific tertiles defined as high (31-60), medium (26-30), and low (12-25). Scores were used as provided by the LASA study.     
**R script**:  
```{r, echo=TRUE}
LASA1F$fqvall_i <- recode(LASA1F$fqvall, "-2=NA")
