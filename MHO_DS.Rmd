...
**Variable description**:  Standardised value (z-score) of the total number of words immediately recalled during a test of verbal memory. If the test is performed more than once, data are based on the first trial.  
**Value type**:  integer    
**Variable unit**:  words  
**Category coding**:  N/A 
...
**Variable description**:  Indicator of whether the participant has low immediate word recall using a median split on the total number of words immediately recalled. If the test is performed more than once, data are based on the first trial.       
**Value type**:  integer  
**Variable unit**:  N/A   
**Category coding**:  
...
**Variable description**:  Standardised value (z-score) of the total number of words recalled following an interval. If the test is performed more than once, data are based on the first trial.    
**Value type**:  integer    
**Variable unit**:  words  
**Category coding**:  N/A  
...
**Variable description**:  Indicator of whether the participant has low delayed word recall using a median split on the total number of words recalled following an interval. If the test is performed more than once, data are based on the first trial.  
**Value type**:  integer  
**Variable unit**:  N/A  
**Category coding**:  
...
**Variable description**:  Indicator of whether the participant has low verbal fluency using a median split on the total number of correctly named words from the given category (animals). If the test is performed more than once, data are based on the first trial.   **Value type**:  integer  
**Variable unit**:  N/A  
**Category coding**:  
